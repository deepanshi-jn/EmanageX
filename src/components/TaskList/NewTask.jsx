  ...
  return (
    <div className='flex-shrink-0 w-[300px] bg-[#252525] border-2 border-indigo-900 rounded-xl p-5 hover:shadow-md transition-all duration-200'>
      <div className='flex justify-between items-center'>
        <span className='px-3 py-1 bg-indigo-900/50 text-indigo-300 rounded-lg text-sm font-medium'>
          {element.category}
        </span>
        <span className='text-sm text-gray-400'>Assigned: {element.assignDate}</span>
      </div>
      ...
      <div className='text-sm text-gray-400 mt-2'>
        ...
        <p>
          <strong>Priority:</strong> {element.priority}
        </p>
      </div>
      <div className='mt-5'>
        <button
